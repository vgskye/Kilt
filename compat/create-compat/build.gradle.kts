...
dependencies {
    ...
    modCompileOnly("net.createmod.ponder:ponder-fabric:${property("ponder_version")}+mc1.21.1")
    modCompileOnly("net.createmod.ponder:ponder-neoforge:${property("ponder_version")}+mc1.21.1")
}
